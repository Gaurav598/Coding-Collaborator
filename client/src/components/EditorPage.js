...
function EditorPage() {
  ...
  const languages = [
    { name: "JavaScript", value: "javascript", pistonLang: "javascript", version: "*", mode: "javascript" },
    { name: "Python", value: "python", pistonLang: "python", version: "*", mode: "python" },
    { name: "Java", value: "java", pistonLang: "java", version: "*", mode: "java" },
    { name: "C++", value: "cpp", pistonLang: "cpp", version: "*", mode: "cpp" },
    { name: "C", value: "c", pistonLang: "c", version: "*", mode: "c" },
  ];
  ...
  const runCode = async () => {
    ...
    try {
      ...
      if (response.data && response.data.run) {
        setOutput(response.data.run.output || "Program ran successfully with no output.");
      } else {
  ...
  const saveCode = async () => {
    ...
    try {
      await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/save-code`, payload);
  ...
  const handleDeleteCode = async (codeId) => {
    try {
      await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/delete-code/${codeId}`);
